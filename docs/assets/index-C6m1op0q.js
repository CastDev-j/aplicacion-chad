...
\r
\r
`;function i(o){o.innerHTML=s;const r=o.querySelector("form");r.addEventListener("submit",a=>{a.preventDefault();const n=new FormData(r),e=Number(n.get("weight"));if(e<0){alert("El peso no puede ser negativo");return}if(e>=100){c();return}alert("El peso es: "+e)})}const c=()=>{u(),d()},u=()=>{const o=document.getElementById("rotatingImage");document.querySelector(".image-container").classList.toggle("animate"),o.classList.toggle("animate")},d=()=>{new Audio("./heavy-song.mp3").play().catch(r=>{console.error("Error al intentar reproducir el audio:",r),alert("El navegador no pudo reproducir el audio.")})};document.querySelector("#app").innerHTML=`
  <h1 class="text-4xl">Calculadora de Salud</h1>

  <div class="app-component">

  </div>
`;const m=document.querySelector(".app-component");i(m);
